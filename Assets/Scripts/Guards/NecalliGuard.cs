...
public class NecalliGuard : MonoBehaviour
{

    private string[] noPermit = { "No tienes el permiso necesario", "Obten el permiso convenciendo al dirigente Naran", "Suerte y hasta la proxima" };
    private string[] permit = { "Adelante caballero", "Tiene el permiso necesario" };
    private string[] finished = { "Hoy es un gran dia", "suerte viajero, hasta luego" };
